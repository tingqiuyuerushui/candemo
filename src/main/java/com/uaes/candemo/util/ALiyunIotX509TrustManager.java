...
public class ALiyunIotX509TrustManager implements X509TrustManager {
    ...
    private String crtPath = "C:\\crt\\root.crt";
    
     public ALiyunIotX509TrustManager() throws Exception{
         //CA根证书，可以从官网下载
         Resource resource = new ClassPathResource("static/crt/root.crt");
//         Resource resource = new ClassPathResource("static/root.crt");
